...
bool PronounceDict::homophones(const string& word1, const string& word2) const
{
    ...
    string uppercase_word1 = word1;
    string uppercase_word2 = word2;
    std::transform(uppercase_word1.begin(), uppercase_word1.end(), uppercase_word1.begin(), ::toupper);
    std::transform(uppercase_word2.begin(), uppercase_word2.end(), uppercase_word2.begin(), ::toupper);
    
    // Retrieve pronunciations for both words
    auto it1 = dict.find(uppercase_word1);
    auto it2 = dict.find(uppercase_word2);
    ...
    // Words not found in the dictionary, so they can't be homophones
    return false;
}
