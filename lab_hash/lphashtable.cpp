...
void LPHashTable<K,V>::insert( K const & key, V const & value ) {
    ...
    size_t idx = hash(key, size); // Compute the initial index
    
    // Probe forward until an empty slot is found or the key matches
    ...
    should_probe[idx] = true; // Mark the slot as occupied
    ++elems; // Increment the number of elements
}
